...
from morgan_etl.jobs import chat_gold_refresh_job, gold_refresh_job, profit_leak_scan_job
...
def build_definitions() -> Definitions:
    ...
    return Definitions(
        assets=[morgan_dbt_assets, refresh_metric_snapshots, scan_profit_leaks],
        jobs=[gold_refresh_job, chat_gold_refresh_job, profit_leak_scan_job],
